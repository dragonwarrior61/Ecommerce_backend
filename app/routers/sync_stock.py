...
from sqlalchemy import any_, update
...
from app.utils.altex.product import post_stock_altex
from app.utils.emag.products import post_stock_emag
        ...
        for new_order in new_orders:
            ...
            for i in range(len(product_id_list)):
                ...
                result = await db.execute(select(Product).where(
                    ...
                    Product.user_id == new_order.user_id
                ))
        ...
        for product in products:
            ...
            for domain in marketplaces:
                ...
                if marketplace.marketplaceDomain == "altex.ro":
                    ...
                    #     continue
                    # await post_stock_altex(marketplace, db_product.barcode_title, stock)
